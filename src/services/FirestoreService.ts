...
export class FirestoreService {
    ...
    async fetchReservationsByDate(date: Date, collection: string): Promise<Reservation[]> {
        ...
        const query = (await collectionRef
            ...
            .get()) as firebase.firestore.QuerySnapshot<Reservation>
        query.forEach((queryDocumentSnapshot) => {
            reservations.push(Reservation.fromJson(queryDocumentSnapshot))
        })
        return reservations
    }
